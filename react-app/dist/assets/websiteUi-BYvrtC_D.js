import{r as u}from"./router-MpwSQkXQ.js";import{l as j,a as k,g as L,b as E}from"./htmlPage-CbIbltgS.js";import{j as h}from"./index-BdunwqsW.js";const P=`<!DOCTYPE html>
...
<body class="text-gray-800">
            ...
            <div class="flex h-20 items-center justify-between">
                ...
                <div class="flex items-center gap-3 sm:gap-6">
                    ...
                    <div class="relative hidden md:block">
                        <a href="fast-bidding.html" id="fastBiddingBtn" class="bg-blue-600 text-white border border-blue-600 px-3 sm:px-4 py-2 rounded-lg text-sm sm:text-base font-semibold hover:bg-blue-600 hover:shadow-lg transition-all flex items-center gap-1">
                            <i data-lucide="zap" class="w-4 h-4"></i> <span class="hidden sm:inline">Fast Bidding</span>
                        </a>
                        <div id="fastBiddingPopup" class="absolute top-full mt-3 left-1/2 -translate-x-1/2 w-56 bg-white rounded-xl shadow-2xl border border-slate-200 p-4 opacity-0 invisible transition-all duration-300 z-50 pointer-events-none">
                            <div class="absolute -top-2 left-1/2 -translate-x-1/2 w-4 h-4 bg-white border-t border-l border-slate-200 rounded-sm transform rotate-45"></div>
                            <div class="text-center">
                                ...
                                <p class="text-slate-900 text-xs font-semibold mt-3">Click to explore →</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container mx-auto px-4 sm:px-6">
                ...
                <div class="mt-16 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-8 md:p-12 border border-blue-100 text-center">
                    ...
                    <div class="flex flex-col md:flex-row gap-4 justify-center">
                        ...
                        <a href="fast-bidding.html" class="inline-flex items-center gap-2 bg-slate-950 hover:bg-black text-white font-bold py-3 px-8 rounded-xl border border-slate-950 transition-colors"><i data-lucide="zap" class="w-5 h-5"></i>Try Fast Bidding</a>
                    </div>
                </div>
            </div>
        </section>
    ...
    <!-- FLOATING BID BUTTON -->
    <div id="floatingFastBiddingBtn" class="fixed bottom-5 right-5 z-50 transition-all duration-300">
        <a
            href="/website/fast-bidding"
            class="group flex max-w-[13rem] items-center gap-3 rounded-2xl border border-slate-950 bg-slate-950 px-3 py-3 text-white shadow-[0_18px_45px_rgba(15,23,42,0.2)] transition-all duration-300 hover:-translate-y-1 hover:bg-black hover:shadow-[0_22px_50px_rgba(15,23,42,0.26)] sm:max-w-none sm:items-center"
            aria-label="Open fast bidding page"
        >
            <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-white text-slate-950 shadow-sm transition-transform duration-300 group-hover:scale-105">
                <i data-lucide="gavel" class="h-5 w-5"></i>
            </span>
            <span class="flex flex-col leading-tight">
                <span class="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-300">Roomhy</span>
                <span class="text-sm font-bold text-white">Fast Bidding</span>
                <span class="hidden text-xs text-slate-300 sm:block">Negotiate within budget</span>
            </span>
            <span class="hidden sm:flex h-9 w-9 items-center justify-center rounded-full bg-white text-slate-950 transition-transform duration-300 group-hover:translate-x-1">
...
`,A=t=>!t||typeof t!="string"||t.startsWith("/")||t.startsWith("http://")||t.startsWith("https://")||t.startsWith("mailto:")||t.startsWith("tel:")||t.startsWith("#")||t.startsWith("data:")?t:t.startsWith("assets/")||t.startsWith("js/")||t.startsWith("images/")||t.startsWith("css/")?`/website/${t}`:t,g=t=>t.replace(/\b(href|src)=("([^"]+)"|'([^']+)')/gi,(e,a,n,o,r)=>{const s=o??r??"",l=A(s);if(l===s)return e;const i=o!=null?'"':"'";return`${a}=${i}${l}${i}`}),S=t=>{const e=t.match(/<body[^>]*>([\s\S]*?)<\/body>/i);return e?e[1]:""},G=t=>{const e=S(t);if(!e)return"";const a=e.match(/<header[\s\S]*?<\/header>/i);return a?g(a[0]).trim():""},q=t=>{const e=S(t);if(!e)return{overlay:"",menu:""};const a=e.match(/<div[^>]*id="menu-overlay"[^>]*>[\s\S]*?<\/div>/i);let n="";const o=e.match(/<div[^>]*id="mobile-menu"[^>]*>/i);if(o){const r=e.indexOf(o[0]);let s=0,l=r;for(let i=r;i<e.length;i+=1)if(e.slice(i,i+4).toLowerCase()==="<div")s+=1;else if(e.slice(i,i+6).toLowerCase()==="</div>"&&(s-=1,s===0)){l=i+6;break}l>r&&(n=e.slice(r,l))}return{overlay:a?g(a[0]).trim():"",menu:g(n).trim()}},y=G(P),{overlay:v,menu:b}=q(P);function z(){return y?h.jsxs(h.Fragment,{children:[h.jsx("div",{dangerouslySetInnerHTML:{__html:y}}),v?h.jsx("div",{dangerouslySetInnerHTML:{__html:v}}):null,b?h.jsx("div",{dangerouslySetInnerHTML:{__html:b}}):null]}):null}const I={Indore:[{name:"PG in Vijay Nagar",area:"Vijay Nagar",type:"PG"},{name:"PG in Palasia",area:"Palasia",type:"PG"},{name:"PG in LIG Colony",area:"LIG Colony",type:"PG"},{name:"PG in Scheme 54",area:"Scheme 54",type:"PG"},{name:"PG in Bhawarkuan",area:"Bhawarkuan",type:"PG"},{name:"PG in South Tukoganj",area:"South Tukoganj",type:"PG"},{name:"Hostel near DAVV",area:"DAVV",type:"Hostel"},{name:"Hostel near IIM Indore",area:"IIM Indore",type:"Hostel"},{name:"Flat in Nipania",area:"Nipania",type:"Apartment"},{name:"PG in AB Road",area:"AB Road",type:"PG"},{name:"PG in MR 10",area:"MR 10",type:"PG"},{name:"Flat in Vijay Nagar",area:"Vijay Nagar",type:"Apartment"}],Kota:[{name:"PG in Talwandi",area:"Talwandi",type:"PG"},{name:"PG in Jawahar Nagar",area:"Jawahar Nagar",type:"PG"},{name:"PG in Vigyan Nagar",area:"Vigyan Nagar",type:"PG"},{name:"PG in Mahaveer Nagar",area:"Mahaveer Nagar",type:"PG"},{name:"Hostel near Allen",area:"Allen",type:"Hostel"},{name:"Hostel near Resonance",area:"Resonance",type:"Hostel"},{name:"Hostel near Bansal Classes",area:"Bansal",type:"Hostel"},{name:"PG in Dadabari",area:"Dadabari",type:"PG"},{name:"Flat in Talwandi",area:"Talwandi",type:"Apartment"},{name:"PG in Rangbari",area:"Rangbari",type:"PG"}],Sikar:[{name:"PG in Subhash Nagar",area:"Subhash Nagar",type:"PG"},{name:"PG in Nehru Nagar",area:"Nehru Nagar",type:"PG"},{name:"PG near Shekhawati University",area:"Shekhawati Uni",type:"PG"},{name:"Hostel near CBSE Schools",area:"CBSE Zone",type:"Hostel"},{name:"Flat in Sikar City",area:"Sikar City",type:"Apartment"},{name:"PG near Bus Stand",area:"Bus Stand",type:"PG"}],Bengaluru:[{name:"PG in BTM Layout",area:"BTM Layout",type:"PG"},{name:"PG in Koramangala",area:"Koramangala",type:"PG"},{name:"PG in HSR Layout",area:"HSR Layout",type:"PG"},{name:"PG in Marathahalli",area:"Marathahalli",type:"PG"},{name:"PG in Manyata Tech Park",area:"Manyata",type:"PG"},{name:"Hostel near RVCE",area:"RVCE",type:"Hostel"},{name:"PG in Bellandur",area:"Bellandur",type:"PG"},{name:"Flat in Koramangala",area:"Koramangala",type:"Apartment"}],Mumbai:[{name:"PG in Andheri",area:"Andheri",type:"PG"},{name:"PG in Bandra",area:"Bandra",type:"PG"},{name:"PG in Powai",area:"Powai",type:"PG"},{name:"PG in Thane",area:"Thane",type:"PG"},{name:"Flat in Andheri",area:"Andheri",type:"Apartment"},{name:"PG in Navi Mumbai",area:"Navi Mumbai",type:"PG"}],Delhi:[{name:"PG in Mukherjee Nagar",area:"Mukherjee Nagar",type:"PG"},{name:"PG near DU North Campus",area:"DU North",type:"PG"},{name:"PG in Dwarka",area:"Dwarka",type:"PG"},{name:"Hostel near JNU",area:"JNU",type:"Hostel"},{name:"PG in Lajpat Nagar",area:"Lajpat Nagar",type:"PG"},{name:"PG in Rohini",area:"Rohini",type:"PG"}],Pune:[{name:"PG in Kothrud",area:"Kothrud",type:"PG"},{name:"PG in Hinjewadi",area:"Hinjewadi",type:"PG"},{name:"PG in Baner",area:"Baner",type:"PG"},{name:"Hostel near COEP",area:"COEP",type:"Hostel"},{name:"Flat in Hinjewadi",area:"Hinjewadi",type:"Apartment"},{name:"PG in Viman Nagar",area:"Viman Nagar",type:"PG"}],Hyderabad:[{name:"PG in Gachibowli",area:"Gachibowli",type:"PG"},{name:"PG in Hitech City",area:"Hitech City",type:"PG"},{name:"PG in Kondapur",area:"Kondapur",type:"PG"},{name:"Hostel near IIIT Hyd",area:"IIIT Hyderabad",type:"Hostel"},{name:"Flat in Gachibowli",area:"Gachibowli",type:"Apartment"},{name:"PG in Ameerpet",area:"Ameerpet",type:"PG"}]},C=()=>{const t=Object.entries(I).map(([a,n])=>`
        <li style="list-style:none;">
          ...
          <ul data-footer-list="${a}" style="display:none;list-style:none;margin:4px 0 8px 11px;padding:0 0 0 10px;border-left:1px solid #1e1e1e;flex-direction:column;gap:8px;">
            ${n.map(o=>`
                  <li style="list-style:none;">
                    <a href="/website/ourproperty?city=${encodeURIComponent(a)}&area=${encodeURIComponent(o.area)}&type=${encodeURIComponent(o.type)}" style="color:#3a3a3a;font-size:12px;text-decoration:none;transition:color 0.15s;display:block;line-height:1.4;">
                      ${o.name}
                    </a>
                  </li>
                `).join("")}
    ...
    <div>
      ...
      <ul style="list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:14px;">
        ${n.map(({label:o,href:r})=>`
              <li style="list-style:none;">
                <a href="${r}" style="color:#555555;font-size:13px;text-decoration:none;transition:color 0.15s;">${o}</a>
              </li>
            `).join("")}
      </ul>
    </div>
...
All rights reserved.</p>
  ...
  `},R=()=>{var r;if(document.querySelector("[data-roomhy-shared-footer='1']"))return;let e=document.querySelector("footer");if(!e){e=document.createElement("footer");const s=document.querySelector(".html-page")||((r=document.querySelector("main"))==null?void 0:r.parentElement)||document.body;s==null||s.appendChild(e)}e.setAttribute("data-roomhy-shared-footer","1"),e.className="",e.style.margin="0",e.style.padding="0",e.style.background="transparent",e.innerHTML=C();const a=e.querySelector("[data-roomhy-footer-root]"),n=e.querySelector("[data-roomhy-footer-grid]"),o=()=>{!a||!n||(window.innerWidth<960?(n.style.gridTemplateColumns="1fr",n.style.gap="28px",n.style.padding="36px 20px 28px",a.querySelectorAll("p").forEach(s=>{var l;(l=s.textContent)!=null&&l.includes("copyright Roomhy")&&(s.style.maxWidth="100%")})):(n.style.gridTemplateColumns="1.4fr 1fr 1fr 1fr 1fr 1fr",n.style.gap="40px",n.style.padding="64px 48px 52px"))};e.querySelectorAll("[data-footer-city]").forEach(s=>{s.addEventListener("click",()=>{const l=s.getAttribute("data-footer-city");e.querySelectorAll("[data-footer-list]").forEach(i=>{const d=i.getAttribute("data-footer-list")===l&&i.style.display!=="flex";i.style.display=d?"flex":"none";const f=i.getAttribute("data-footer-list"),c=e.querySelector(`[data-footer-dot="${f}"]`),m=e.querySelector(`[data-footer-chevron="${f}"]`),p=e.querySelector(`[data-footer-city="${f}"]`);d?(c&&(c.style.backgroundColor="#4ade80",c.style.border="none"),m&&(m.style.transform="rotate(180deg)"),p&&(p.style.color="#ffffff",p.style.fontWeight="600")):(c&&(c.style.backgroundColor="transparent",c.style.border="1px solid #2a2a2a"),m&&(m.style.transform="rotate(0deg)"),p&&(p.style.color="#555555",p.style.fontWeight="400"))})})}),o(),window.addEventListener("resize",o)},M=()=>{if(document.querySelector("[data-roomhy-shared-header='1']")||document.getElementById("menu-toggle")&&document.getElementById("mobile-menu"))return;const e=[y,v,b].filter(Boolean).join(`
`);if(!e)return;const a=document.createElement("div");a.setAttribute("data-roomhy-shared-header","1"),a.innerHTML=e;const n=document.querySelector(".html-page")||document.body;n&&n.insertBefore(a,n.firstChild||null)},H=(t=[])=>{u.useEffect(()=>{var e;(e=window.lucide)!=null&&e.createIcons&&window.lucide.createIcons()},t)},x=()=>{const t=document.getElementById("welcomeUserName"),e=document.getElementById("userIdDisplay");k()?(t&&(t.textContent=`Hi, ${L()}`),e&&(e.textContent=`ID: ${E()}`)):(t&&(t.textContent="Hi, welcome"),e&&(e.textContent=""))},w=()=>{const t=document.getElementById("menu-logged-in"),e=document.getElementById("menu-logged-out"),a=k();t&&(a?t.classList.remove("hidden"):t.classList.add("hidden")),e&&(a?e.classList.add("hidden"):e.classList.remove("hidden"))},O=()=>{H([]),u.useEffect(()=>{window.globalLogout=()=>j("login");try{M()}catch(e){console.error("Shared header injection failed:",e)}w(),x();try{R()}catch(e){console.error("Shared footer injection failed:",e)}const t=()=>{w(),x()};return window.addEventListener("storage",t),window.addEventListener("roomhy:website-session-changed",t),()=>{window.removeEventListener("storage",t),window.removeEventListener("roomhy:website-session-changed",t),window.globalLogout&&delete window.globalLogout}},[])},F=()=>{u.useEffect(()=>{const t=document.getElementById("menu-toggle"),e=document.getElementById("menu-close"),a=document.getElementById("menu-close-logout"),n=document.getElementById("mobile-menu"),o=document.getElementById("menu-overlay"),r=document.getElementById("mobile-menu-drawer"),s=document.getElementById("mobile-menu-overlay"),l=()=>{w(),x(),n&&n.classList.remove("translate-x-full"),r&&r.classList.remove("translate-x-full"),o&&o.classList.remove("hidden"),s&&(s.classList.remove("hidden"),s.classList.add("opacity-100"),document.body.style.overflow="hidden")},i=()=>{n&&n.classList.add("translate-x-full"),r&&r.classList.add("translate-x-full"),o&&o.classList.add("hidden"),s&&(s.classList.remove("opacity-100"),setTimeout(()=>s.classList.add("hidden"),300),document.body.style.overflow="")};return t==null||t.addEventListener("click",l),e==null||e.addEventListener("click",i),a==null||a.addEventListener("click",i),o==null||o.addEventListener("click",i),s==null||s.addEventListener("click",i),n==null||n.querySelectorAll("a").forEach(d=>{d.addEventListener("click",i)}),r==null||r.querySelectorAll("a").forEach(d=>{d.addEventListener("click",i)}),()=>{t==null||t.removeEventListener("click",l),e==null||e.removeEventListener("click",i),a==null||a.removeEventListener("click",i),o==null||o.removeEventListener("click",i),s==null||s.removeEventListener("click",i),n==null||n.querySelectorAll("a").forEach(d=>{d.removeEventListener("click",i)}),r==null||r.querySelectorAll("a").forEach(d=>{d.removeEventListener("click",i)})}},[])},W=(t=5e3)=>{u.useEffect(()=>{const e=document.getElementById("hero-image-wrapper");if(!e)return;const a=e.querySelectorAll("img");if(a.length<=1)return;let n=0;const o=setInterval(()=>{const r=(n+1)%a.length;a[n].classList.remove("opacity-100"),a[n].classList.add("opacity-0"),a[r].classList.remove("opacity-0"),a[r].classList.add("opacity-100"),n=r},t);return()=>clearInterval(o)},[t])},U=()=>{u.useEffect(()=>{const t=Array.from(document.querySelectorAll(".faq-item"));if(!t.length)return;const e=t.map(a=>{const n=a.querySelector(".faq-question"),o=a.querySelector(".faq-answer"),r=a.querySelector(".chevron");if(!n||!o||!r)return null;const s=()=>{document.querySelectorAll(".faq-answer.active").forEach(l=>{var i;if(l!==o){l.classList.remove("active");const d=(i=l.previousElementSibling)==null?void 0:i.querySelector(".chevron");d==null||d.classList.remove("rotated")}}),o.classList.toggle("active"),r.classList.toggle("rotated")};return n.addEventListener("click",s),{question:n,handler:s}});return()=>{e.forEach(a=>{a!=null&&a.question&&(a!=null&&a.handler)&&a.question.removeEventListener("click",a.handler)})}},[])};export{z as W,O as a,W as b,U as c,H as d,P as t,F as u};

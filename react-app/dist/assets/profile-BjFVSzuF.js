import{j as e}from"./index-LfGPIU1v.js";import"./router-MpwSQkXQ.js";import{u as s}from"./htmlPage-Ds81bKEl.js";import{u as i}from"./legacyUi-4bt1Vx-I.js";function d(){return s({title:"Roomhy - Admin Profile",bodyClass:"text-slate-800",htmlAttrs:{lang:"en"},metas:[{charset:"UTF-8"},{name:"viewport",content:"width=device-width, initial-scale=1.0"}],bases:[],links:[{href:"https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap",rel:"stylesheet"},{rel:"stylesheet",href:"/superadmin/assets/css/profile.css"}],styles:[],scripts:[{src:"https://cdn.tailwindcss.com"},{src:"https://unpkg.com/lucide@latest"}],inlineScripts:[]}),i(),e.jsx("div",{className:"html-page",dangerouslySetInnerHTML:{__html:`

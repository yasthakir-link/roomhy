import{j as e}from"./index-LfGPIU1v.js";import"./router-MpwSQkXQ.js";import{u as t}from"./useHeadAssets-BrbygJPI.js";import"./htmlPage-Ds81bKEl.js";const a="Roomhy - Area Admin Dashboard",s=[{charset:"UTF-8"},{name:"viewport",content:"width=device-width, initial-scale=1.0"}],r=[{href:"https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap",rel:"stylesheet"},{rel:"stylesheet",href:"/superadmin/assets/css/areaadmin.css"}],i=[{content:`// API Configuration
        const API_URL = (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1')
            ? 'http://localhost:5001'
            : 'https://api.roomhy.com';`},{src:"https://cdn.tailwindcss.com"},{src:"https://unpkg.com/lucide@latest"},{src:"https://cdn.jsdelivr.net/npm/chart.js"},{content:`(() => {
        ...
        });`},{src:"/superadmin/assets/js/areaadmin.js"}],o={lang:"en"},n={class:"text-slate-800"},l=`<div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
    ...
    </div>`;function g(){return t({title:a,metas:s,links:r,scripts:i,htmlAttrs:o,bodyAttrs:n}),e.jsx("div",{dangerouslySetInnerHTML:{__html:l}})}export{g as default};

import{j as L}from"./index-CLL8BaHC.js";import{r as R}from"./router-MpwSQkXQ.js";import{u as O}from"./useHeadAssets-2w01Mxi9.js";import{i as _,r as M}from"./htmlPage-BWFwXoiN.js";const P=()=>{R.useEffect(()=>{try{_()}catch{}const i=()=>{try{M()}catch{}};i();const r=setTimeout(i,100),a=setTimeout(i,300);return()=>{clearTimeout(r),clearTimeout(a)}},[])},$="Roomhy - Super Admin Dashboard",z=[{charset:"UTF-8"},{name:"viewport",content:"width=device-width, initial-scale=1.0"}],J=[{rel:"preconnect",href:"https://fonts.googleapis.com"},{rel:"preconnect",href:"https://fonts.gstatic",crossorigin:!0},{href:"https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap",rel:"stylesheet"},{rel:"stylesheet",href:"/superadmin/assets/css/superadmin.css"}],H=[{src:"https://cdn.tailwindcss.com"},{src:"https://unpkg.com/lucide@latest"},{src:"https://cdn.jsdelivr.net/npm/chart.js"},{content:`const API_URL = (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1')\r

...
export default function WebsitePrivacy() {
  ...
  useHtmlPage({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "/website/assets/css/privacy.css" }
    ],
    styles: [],
    scripts: [
    ...
    <div className="html-page">
      ...
      <div id="menu-logged-out" className="fixed top-0 right-0 w-80 h-full bg-white z-50 shadow-xl transform translate-x-full transition-transform duration-300 ease-in-out flex flex-col">
        ...
        <div className="p-4 border-t flex-shrink-0 space-y-3">
          <a href="/website/login" className="block w-full text-center bg-white border border-blue-600 text-blue-600 hover:bg-blue-50 font-medium py-2 px-4 rounded-lg transition-colors">Login</a>
          <a href="/website/signup" className="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition-colors">Sign Up</a>
        </div>
      </div>
